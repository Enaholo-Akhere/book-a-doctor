      ...
      <div className='container'>
        <div className='flex justify-between gap-[80px] xl:gap-0 flex-col lg:flex-row items-center'>
          ...
          <MotionDiv
            ...
            className='relative w-[100%] lg:w-[50%] z-10 order-2 lg:order-1'
          >
            <div className='w-[80%]'>
          ...
          <MotionDiv
            ...
            className='w-[100%] lg:w-[40%] order-1 lg:order-2'
          >
            ...
            <MotionDiv variants={textItemVariant}>
              <p className='text__para'>
                ...
                us as one of the best publics healthcare group in the Nation and
                #1 in Texas.
              </p>
            </MotionDiv>
            <MotionDiv variants={textItemVariant}>
              <p className='text__para mt-[30px] mb-5'>
                ...
                patients and not looking back at what we accomplished but
                towards what we can do tomorrow.
              </p>
            </MotionDiv>
            <MotionDiv variants={textItemVariant}>
              <Link to='/'>
