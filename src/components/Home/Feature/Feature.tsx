      ...
      <div className='container'>
        <div className='flex md:items-center justify-between flex-col lg:flex-row m-auto'>
          ...
          <MotionDiv
            ...
            className='xl:w-[670px] lg:w-[480px] w-[100%] pr-[20px]'
          >
          ...
          >
            ...
            <MotionDiv
              ...
              className='w-[150px] left-[10px] lg:w-[248px] bg-white absolute bottom-[50px] md:bottom-[100px] sm:left-[150px] md:left-[-100px] xl:left-[50px] 2xl:left-[150px] lg:left-[-150px] z-20 p-2 pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px]'
            >
